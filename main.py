...
class Instabot:
    ...
    def login(self, username, password):
        ...
        self.loginusername = ummu_001sena
        self.loginpassword = emirhangunel44
...
insta.rep(
    ...
    "905376415890",
    # message :
    "Hi, Instagram my account has been disabling for violating terms, I think it has been a mistake, please recover my account .",
    # loop :
    1000)
